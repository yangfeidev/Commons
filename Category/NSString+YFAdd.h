...
/**
 ...
 @return 是否是合法邮箱
 */
- (BOOL)yf_isValidateEmail:(NSString *)email;
...
/**
 ...
 @param urlString unencodeURLString
 @return encodeURLString
 */
+ (NSString *)yf_encodeURLString:(NSString *)urlString;

/**
 urlString decode

 @param urlString encodeURLString
 @return decodeURLString
 */
+ (NSString *)yf_decodeURLString:(NSString *)urlString;
